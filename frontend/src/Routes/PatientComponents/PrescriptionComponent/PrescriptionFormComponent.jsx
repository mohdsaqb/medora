...
export default class PrescriptionFormComponent extends Component {
    ...
    savePrescription = (e) => {
        let data = this.state;
        PrescriptionService.save(data).then(res => {
            data = res.data;
            if(data.prescriptionid>0){
                AlertifyService.successMessage("Saving prescription for related problem is ok.. "); 
                // this.setState({          
                //     detail: '',
                //     drug_detail: '', 
                //     barcode: '', 
                ...
                AlertifyService.alert("Saving prescription for related problem is not ok.. ");
            }
        });
    }
    render() {
        let {detail, drug_detail, barcode, usage, delivery_date} = this.state;
        ...
        return (
            <div className="row">
                ...
                <div className="col-sm-9">
                    <h2 className="text-center">ADD PRESCRIPTION</h2>
                    <hr />
                    <form>
                        ...
                        <div className="form-group">
                            ...
                            <input 
                                ...
                                name="usage" 
                                className="form-control" 
                                value={usage} onChange={e => this.onChangeData('usage', e.target.value)} />
                        </div>
                        <div className="form-group">
                            <label >Barcode</label>
                            <input 
                        ...
                        <button className="btn btn-success" type="button"  onClick={this.savePrescription} >Add</button>
                    </form>
                    <hr/>
                </div>
